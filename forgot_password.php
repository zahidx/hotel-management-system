    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="user_validation_check.php">
                        <!-- Set the action to the PHP script for handling password reset -->
                        ...
                        <div style="text-align: center;">
                            <button class="btn btn--radius-2 btn--red" type="submit">Reset Password</button>
                        </div>
                    </form>
                </div>
            </div>
